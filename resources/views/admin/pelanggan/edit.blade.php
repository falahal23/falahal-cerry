    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb
                    -item active" aria-current="page">Edit Data</li>
            </ol>
        </nav>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="birthday" name="birthday"
                                        class="form-control"value="{{ $dataPelanggan->birthday }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="gender" name="gender" class="form-select">
                                        ...
                                        <option value="Male">"Male"{{ $dataPelanggan->gender == 'male' ? 'selected' : '' }}
                                        </option>
                                        <option value="Female">
                                            "Female"{{ $dataPelanggan->gender == 'Female' ? 'selected' : '' }} </option>
